...
public class AddAdmin extends  JPanel implements ActionListener{
    ...
    JLabel  NameLabel ,idLabel, Passwordlabel  ,headlabel;
    JTextField  Name , Password , id ;
    ...
    headlabel = new JLabel("Add Admin");
    ...
    Password.setBounds(150, 110, 120, 25);
   ...
   // ... in .. send and back button
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==send) {
            try {
                DataBase.administratorDataBase.insertAdmin(Integer.parseInt(id.getText()),Name.getText(), Password.getText());
                JOptionPane.showMessageDialog(null, "Admin Has Been added Successfully.", "Attention", JOptionPane.INFORMATION_MESSAGE);
         ...
         if (e.getSource()==del) {
            try {
                DataBase.administratorDataBase.DeleteAdmin(Integer.parseInt(id.getText()));
                JOptionPane.showMessageDialog(null, "Admin Has Been Deleted Successfully.", "Attention", JOptionPane.INFORMATION_MESSAGE);
          ...
          if (e.getSource()==update) {
            try {
                DataBase.administratorDataBase.UpdateAdmin(Integer.parseInt(id.getText()),Name.getText(),Password.getText());
